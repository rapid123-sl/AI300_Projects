...
# Version to be used but includes the percentyeschurn & percentnochurn - input_processing works
...
# for home.html
            ...
            #      <h3>Likelihood of churning: {{ percentyeschurn }}</h3>
            #      <h3>Likelihood of not churning: {{ percentnochurn }}</h3>
            # {% endif %}